...
#define cyclelength 8000 //millis 
...
/*
  ...
  */
  ...
  Serial.print(SET_POINT_1);
  Serial.print(" ");
  Serial.print(double(counter_1 * 1.56 * GEAR_RATIO));
  Serial.print(" ");
  
 
   Serial.print(SET_POINT_2);
  Serial.print("        ");
  Serial.print(double(counter_2 * 1.56 * GEAR_RATIO));
  //Serial.println();
  Serial.print("        ");
  ...
  Serial.print(" ");
  Serial.print(" ");
  Serial.print(double(counter_3 * 1.56 * GEAR_RATIO));
  Serial.print("        ");

 Serial.print(SET_POINT_4);
  Serial.print("         ");
 
  Serial.print(double(counter_4 * 1.56 * GEAR_RATIO));
Serial.print("        ");
  Serial.println();
  delay(10);
